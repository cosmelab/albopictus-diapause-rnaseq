#!/usr/bin/env Rscript
#
# Embryo Differential Expression Analysis with DESeq2
#
...
#
# Output:
#   - results/differential_expression/embryos/deseq2_results_all.tsv
#   - results/differential_expression/embryos/significant_genes_fdr05.tsv
#   - results/differential_expression/embryos/statistics_summary.txt
#
# Author: LCosme
...
cat("===============================================================\n")
cat("Embryo Differential Expression Analysis with DESeq2\n")
cat("===============================================================\n\n")
...
results_dir <- file.path(project_base, "results/differential_expression/embryos")
dir.create(results_dir, recursive = TRUE, showWarnings = FALSE)

# Load data
cat("Loading count matrix and metadata...\n")
counts <- read.delim(file.path(count_dir, "embryos_counts.tsv"), row.names = 1, check.names = FALSE)
metadata <- read.csv(file.path(count_dir, "embryos_metadata.csv"), row.names = 1)
