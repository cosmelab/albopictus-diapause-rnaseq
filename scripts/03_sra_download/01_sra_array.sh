...
singularity exec --cleanenv --bind $BIND_PATH $CONTAINER_PATH bash -c "cd /proj && python scripts/03_sra_download/02_sra_download.py --dataset $DATASET --output-dir data --max-workers 6"
